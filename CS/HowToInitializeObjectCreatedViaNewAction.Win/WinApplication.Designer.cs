namespace HowToInitializeObjectCreatedViaNewAction.Win {
   partial class HowToInitializeObjectCreatedViaNewActionWindowsFormsApplication {
      /// <summary> 
      ...
      private void InitializeComponent() {
         ...
         this.module4 = new HowToInitializeObjectCreatedViaNewAction.Module.Win.HowToInitializeObjectCreatedViaNewActionWindowsFormsModule();
         ...
         this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.HowToInitializeObjectCreatedViaNewActionWindowsFormsApplication_DatabaseVersionMismatch);
